...
public class documents {
    ...
    private String typeAvant;            // type avant conversion
    private String typeApres;            // type après conversion
    private Timestamp dateConversion;    // date de conversion
    private String nomFichierConverti;   // nom réel du fichier sur le disque
